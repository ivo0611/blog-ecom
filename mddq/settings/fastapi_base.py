"""
Django settings for mddq project.
...
WSGI_APPLICATION = "mddq.wsgi.application"
...
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")  # Đặt riêng thư mục
